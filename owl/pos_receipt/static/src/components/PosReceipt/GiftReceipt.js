odoo.define('point_of_sale.OrderGiftReceipt', function(require) {
    'use strict';

    const PosComponent = require('point_of_sale.PosComponent');
    const Registries = require('point_of_sale.Registries');

    class OrderGiftReceipt extends PosComponent {
        constructor() {
            super(...arguments);
    ...
    OrderGiftReceipt.template = 'OrderGiftReceipt';

    Registries.Component.add(OrderGiftReceipt);

    return OrderGiftReceipt;
});
